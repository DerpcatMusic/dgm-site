					...
					{#each $artists as artist, index}
						...
						>
							...
							<div class="relative">
								<div class="aspect-square relative">
									...
									{:else}
										<div class="w-full h-full bg-neo-blue flex items-center justify-center">
											<span class="text-white text-6xl font-black uppercase">{artist.name.charAt(0)}</span>
										</div>
									{/if}
								...
								<div class="p-6">
									<h3 class="text-2xl font-black text-black mb-3 uppercase tracking-wider">{artist.name}</h3>
									{#if artist.bio}
										<p class="text-neo-gray font-semibold text-base mb-4 line-clamp-2">{artist.bio}</p>
									{/if}
...
{#if showForm}
	...
	>
				...
				<form onsubmit={handleSubmit} class="space-y-8">
					...
					<!-- Bio -->
					<div>
						<label for="bio" class="block text-xl font-black uppercase tracking-wider text-black mb-4">Bio</label>
						<textarea
							id="bio"
					...
					<!-- Image Upload -->
					<div>
						<label for="image-upload" class="block text-xl font-black uppercase tracking-wider text-black mb-4"
							>Image</label
						>
						<div
					...
					<div>
						...
						<div class="flex gap-4 mb-4" role="group" aria-labelledby="genres-heading">
							...
							/>
							<div id="genre-help" class="sr-only">
								Type a genre name and press Enter or click Add
							</div>
							<Button
								variant="primary"
								size="md"
					...
					<div>
						...
						<div class="grid grid-cols-2 gap-4 mb-4" role="group" aria-labelledby="social-heading">
							...
							<div id="url-help" class="sr-only">
								Enter the full URL to the social media profile
							</div>
						</div>
						<Button
							variant="success"
