<script lang="ts">
	...
	// Base classes
	let baseClasses =
		'btn-neo inline-flex items-center justify-center font-black uppercase tracking-wider border-4 border-black transition-all duration-100 focus:outline-none focus:ring-4 focus:ring-black focus:ring-opacity-50';
